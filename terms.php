...
<body>
    ...
    <div class="container">
        ...
        <div class="btn-row">
            <a href="login/customer_register.php" class="btn btn-secondary">← Back to register as a customer</a>
            <?php if (!$user_name): ?>
                <a href="/Smart_Greenhouse_Products_Marketplace/login/owner_register.php" class="btn btn-primary">Back to register as a owner</a>
            <?php else: ?>
